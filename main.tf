...
module "network" {
  ...
  network_settings = {
    vnc_display_name     = var.vnc_display_name ####
    vnc_cidr_block       = var.vnc_cidr_block   ###
    privreg_cidr_block   = "10.1.4.0/24"
    pubsb2_cidr_block    = "10.1.3.0/24"
    lb_pub_cidr_block    = "10.1.5.0/24"
    privreg_display_name = var.privreg_display_name ##
    pubreg_display_name  = var.pubreg_display_name
    pubreg_cidr_block    = var.pubreg_cidr_block
    pubsb1_cidr_block    = var.pubsb1_cidr_block
...
module "database" {
  ...
  dbcs = {
    ...
    database_ssh_public_keys = ["wls-wdt-testkey-pub.txt", ]
