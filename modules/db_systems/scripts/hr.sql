...
##   ./gen-adw.sh `cat sql_connect.sh` > adw_sql.sh
###   remove from the last user the ',' 

source /home/oracle/EXPORT-env
##export SYSADMINSQL=`sqlplus sys/$PASSWORD@$PDB as sysdba`
...
####
####-- ROLES
####GRANT "CONNECT" TO "eugene" ;
####GRANT "RESOURCE" TO "eugene" ;


$SYSADMINSQL << EOF
drop user hr cascade;
create user hr identified by "$HRUSER_PASSWRD"
DEFAULT TABLESPACE "USERS"
TEMPORARY TABLESPACE "TEMP";
